...
export const Dashboard = () => {
  ...
  const Header = () => (
    <header className="border-b border-border bg-background px-6 py-4 flex flex-col justify-between gap-4 md:h-20 md:flex-row md:items-center">
      <div>
            ...
            {data && (
              <div className="border-t border-border">
                <Sidebar
                  ...
                  isLoading={isLoading}
                  onLocationSelect={handleLocationSelect}
                  className="h-auto w-full border-none shadow-none"
                />
              </div>
            )}
          </ScrollArea>
